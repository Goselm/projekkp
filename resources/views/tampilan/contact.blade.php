    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="tampilan.contact" class="nav-item nav-link">Courses</a>
                ...
                <a href="tampilan.contact" class="nav-item nav-link active">Contact</a>
            </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">Pasar Swadaya Sungai Raya Dalam, Kompleks Beltran Riverside No.P8, Kec. Pontianak Kota, Kota Pontianak, Kalimantan Barat</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                        ...
                        <div class="ms-3">
                            <h5 class="text-primary">Mobile and WA</h5>
                            <p class="mb-0">+6289656695010</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">stevengaming182@gmail.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <iframe class="position-relative rounded w-100 h-100"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.8144661782376!2d109.35192318071462!3d-0.07963908318507204!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e1d590187389ac1%3A0xc82aaf9ff3411ea2!2sFUN%20COURSE!5e0!3m2!1sen!2sid!4v1706343146725!5m2!1sen!2sid"

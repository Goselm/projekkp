    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- START FORM -->
                    <form action="/updatebaru/{{ $jadwals->id }}" method="POST">
                        @csrf
                        <div class="my-3 p-3 bg-body rounded shadow-sm">
                            <div class="mb-3 row">
                                <label for="siswa" class="col-sm-2 col-form-label">Siswa</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name='siswa' id="siswa" value="{{ $jadwals->siswa }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="karyawan" class="col-sm-2 col-form-label">Karywan</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name='karyawan' id="karyawan" value="{{ $jadwals->karyawan }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="mata_pelajaran" class="col-sm-2 col-form-label">Mata Pelajaran</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name='mata_pelajaran' id="mata_pelajaran" value="{{ $jadwals->mata_pelajaran }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
